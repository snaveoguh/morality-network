...
exports.hardenedFetch = hardenedFetch;
exports.extractTitle = extractTitle;
exports.extractCanonical = extractCanonical;
exports.isAcceptableContentType = isAcceptableContentType;
...
function isPrivateHost(hostname) {
    ...
    if (PRIVATE_IP_PREFIXES.some((prefix) => lower.startsWith(prefix)))
        return true;
    // Block [::1] style IPv6
 ...
 */
async function hardenedFetch(url, method = "HEAD") {
...
// CONTENT TYPE VALIDATION
// ============================================================================
function isAcceptableContentType(contentType) {
    if (!contentType)
        return false;
...
// ============================================================================
async function verifyEvidence(rawUrl) {
    // 1. Validate URL
    ...
    const parsed = (0, evidence_1.parseEvidenceInput)(url.toString());
