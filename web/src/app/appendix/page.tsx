...
const API_ENDPOINTS: { category: string; endpoints: ApiEntry[] }[] = [
  {
    ...
    endpoints: [
      ...
      { method: "GET", path: "/api/newsroom", description: "Newsroom data", auth: "PUBLIC" },
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "POST", path: "/api/evidence/verify", description: "Verify evidence", auth: "AUTH" },
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "GET", path: "/api/trading/readiness", description: "Trading readiness", auth: "PUBLIC" },
      ...
      { method: "GET", path: "/api/trading/journal", description: "Trade execution journal", auth: "PUBLIC" },
      { method: "GET", path: "/api/trading/performance", description: "Portfolio performance metrics", auth: "PUBLIC" },
      { method: "GET", path: "/api/trading/learning", description: "Self-learning report", auth: "PUBLIC" },
    ],
  },
  {
    category: "Agents",
    endpoints: [
      { method: "GET", path: "/api/agents", description: "Agent list", auth: "PUBLIC" },
      ...
      { method: "GET", path: "/api/agents/bus", description: "Agent message bus", auth: "PUBLIC" },
      { method: "POST", path: "/api/agents/bus/relay", description: "Message relay", auth: "AUTH" },
      { method: "GET", path: "/api/agents/coordinator", description: "Agent coordination", auth: "PUBLIC" },
      { method: "GET", path: "/api/agents/console", description: "Agent console", auth: "PUBLIC" },
      { method: "GET", path: "/api/agents/events/stream", description: "Agent events (SSE)", auth: "PUBLIC" },
      ...
      { method: "GET", path: "/api/agents/memory/stats", description: "Memory stats", auth: "PUBLIC" },
      { method: "GET", path: "/api/agents/memory/debug", description: "Memory debug", auth: "AUTH" },
      { method: "GET", path: "/api/agents/swarm", description: "Research swarm output", auth: "PUBLIC" },
    ],
  },
  {
    category: "Auth (SIWE)",
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "GET", path: "/api/terminal/subscription/status", description: "Subscription status", auth: "AUTH" },
      { method: "GET", path: "/api/terminal/risk", description: "Risk assessment", auth: "PUBLIC" },
  ...
  },
  {
    ...
    endpoints: [
      { method: "GET", path: "/api/moral-compass/crawl", description: "Ethics/philosophy crawl (cron)", auth: "PUBLIC" },
  ...
  },
  {
    ...
    endpoints: [
      { method: "GET", path: "/api/moral-commentary/generate", description: "Daily moral commentary (cron)", auth: "PUBLIC" },
    ],
  },
];
