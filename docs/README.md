# pooter world v2 Documentation

This folder is the source of truth for architecture, style, deployments, and public API surface.
...
This docs pack was created as a docs-first track while feature development continues in parallel.
It intentionally avoids modifying active app/contract behavior.
